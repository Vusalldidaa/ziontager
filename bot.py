...
async def help(event):
  helptext = "**Zion Tag bot'un Yardım Menüsü**\n\nKomut: /all \n  Bu komutu, başkalarına bahsetmek istediğiniz metinle birlikte kullanabilirsiniz. \n`Örnek: /all Günaydın!`  \nBu komutu yanıt olarak kullanabilirsiniz. herhangi bir mesaj Bot, yanıtlanan iletiye kullanıcıları etiketleyecek /cancel- bu komut ile islemi durdura bilirsin Sohbet Kanalimiz @piramidasohbet gelmeyi unutma"
...
print(">> Bot çalıyor merak etme 🚀 @Roxy_Boss bilgi alabilirsin <<")
